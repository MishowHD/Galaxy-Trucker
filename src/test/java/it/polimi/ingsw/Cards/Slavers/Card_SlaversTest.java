...
import it.polimi.ingsw.Model.Cards.Slavers.SlaversCalcState;
import it.polimi.ingsw.Model.Cards.Slavers.SlaversEndState;
import it.polimi.ingsw.Model.Cards.Slavers.SlaversLosingState;
import it.polimi.ingsw.Model.Cards.Slavers.SlaversWinningState;
...
//PLayer 4
        ...
        assertTrue(mainGame.getGameState().getCardinuse().getState() instanceof SlaversCalcState);

        //right player, wrong input.
        ...
        //perde. perde utenti
        assertTrue(mainGame.getGameState().getCardinuse().getState() instanceof SlaversLosingState);
        mainGame.getGameState().getCardinuse().getState().getNextState();
        //wrong input
        gameController.choosePassengersToLose(mainGame.getPlayer(giuseppe), true,
                new ArrayList<>(List.of(
                        new ArrayList<>(List.of(1, 1, 2)),
                        new ArrayList<>(List.of(2, 4, 1))
                )), mainGame.getGameFlightBoard());
        ...
        //wrong player
        gameController.choosePassengersToLose(mainGame.getPlayer(loreto), true,
                new ArrayList<>(List.of(
                        new ArrayList<>(List.of(1, 1, 2)),
                        new ArrayList<>(List.of(2, 0, 1))
                )), mainGame.getGameFlightBoard());
        ...
        assertInstanceOf(SlaversWinningState.class, mainGame.getGameState().getCardinuse().getState());
        mainGame.getGameState().getCardinuse().getState().getNextState();

        //wrong player
        gameController.chooseToClaimReward(false, mainGame.getPlayer(giuseppe));

        //right player
        gameController.chooseToClaimReward(true, mainGame.getPlayer(loreto));

        assertInstanceOf(SlaversEndState.class, mainGame.getGameState().getCardinuse().getState());
        mainGame.getGameState().getCardinuse().getState().getNextState();

        assertEquals(23, mainGame.getPlayer(loreto).getPositionOnBoard());
        assertEquals(-1, mainGame.getPlayer(loreto).getNumFullRounds());
        assertEquals(6, mainGame.getPlayer(giuseppe).getPositionOnBoard());
        assertEquals(0, mainGame.getPlayer(giuseppe).getNumFullRounds());
        assertEquals(1, mainGame.getPlayer(giacomo).getPositionOnBoard());
        assertEquals(0, mainGame.getPlayer(giacomo).getNumFullRounds());
        ...
        //devo prendere le money
        assertEquals(5, mainGame.getPlayer(loreto).getMyShip().getCosmicCredits());


    }

    @Test
    void cardTestMotors() throws Exception {
        EventBus b = mainGame.getEventBus();
        gameController = new GameController(mainGame, b);
        gameController.JoinGame("Loreto", 4);
        gameController.JoinGame("Giuseppe", 0);
...
//SECONDO GIOCATORE
        ...
        mainGame.getGameState().pickTile(87, giuseppe);
        mainGame.getGameState().insertTile(3, 0, giuseppe, 0);
...
//PLayer 4
        ...
        gameController.chooseOneSubShip(0,lorenzo);
        gameController.setNumTile(lorenzo,0);
        System.out.println(mainGame.getGameState());

    }

    @Test
    void cardTestMotors2() throws Exception {
        EventBus b = mainGame.getEventBus();
        gameController = new GameController(mainGame, b);
        gameController.JoinGame("Loreto", 4);
        gameController.JoinGame("Giuseppe", 0);
...
//PLayer 4
    ...
    @Test
    void cardTestDouble() throws Exception {
        EventBus b = mainGame.getEventBus();
        gameController = new GameController(mainGame, b);
        gameController.JoinGame("Loreto", 4);
        gameController.JoinGame("Giuseppe", 0);
...
//PLayer 4
        ...
        mainGame.getGameState().pickTileUnknown(lorenzo);
        mainGame.getGameState().pickTileUnknown(giacomo);
        assertFalse( mainGame.getPlayer(lorenzo).InsertTile(mainGame.getPlayer(giacomo).getTileInHand(),0,0));
        ...
        mainGame.getGameFlightBoard().movePlayer(mainGame.getPlayer(loreto),37);
        mainGame.getGameFlightBoard().movePlayer(mainGame.getPlayer(loreto),-37);
    ...
    @Test
    void cardTestWinnerRefuses() throws Exception {
        EventBus b = mainGame.getEventBus();
        gameController = new GameController(mainGame, b);
        gameController.JoinGame("Loreto", 4);
        gameController.JoinGame("Giuseppe", 0);
...
//PLayer 4
        ...
        //right player
        gameController.chooseToClaimReward(false, mainGame.getPlayer(loreto));
        ...
        //devo prendere le money
        assertEquals(0, mainGame.getPlayer(loreto).getMyShip().getCosmicCredits());
...
//PLayer 4
        ...
        assertInstanceOf(SlaversCalcState.class, mainGame.getGameState().getCardinuse().getState());
        mainGame.getGameState().getCardinuse().getState().getNextState();

        //il giocatore sceglie di accendere i cannoni. PAREGGIA
        gameController.chooseCannonBatteryPos(
                mainGame.getGameFlightBoard(),
                mainGame.getPlayer(loreto),
                new ArrayList<>(List.of(
    ...
    @Test
    void buildingTestEngine1() throws Exception {
        EventBus b = mainGame.getEventBus();
        gameController = new GameController(mainGame, b);
        gameController.JoinGame("Loreto", 4);
        gameController.JoinGame("Giuseppe", 0);
        ...
        gameController.activateTimer(mainGame.getPlayer(loreto));
//PRIMO GIOCATORE
       mainGame.getGameState().pickTile(85, loreto);
       mainGame.getGameState().insertTile(2,4,loreto,90);
        mainGame.getGameState().pickTile(86, loreto);
        mainGame.getGameState().insertTile(3,4,loreto,180);
        mainGame.getGameState().pickTile(87, loreto);
        mainGame.getGameState().insertTile(2,5,loreto,270);


        mainGame.getGameState().pickTile(88, giuseppe);
        mainGame.getGameState().insertTile(2,4,giuseppe,90);
        mainGame.getGameState().pickTile(89, giuseppe);
        mainGame.getGameState().insertTile(3,4,giuseppe,180);

        mainGame.getGameState().pickTile(90, giacomo);
        mainGame.getGameState().insertTile(2,4,giacomo,90);
        mainGame.getGameState().pickTile(91, giacomo);
        mainGame.getGameState().insertTile(3,4,giacomo,180);

        mainGame.getGameState().pickTile(92, lorenzo);
        mainGame.getGameState().insertTile(2,4,lorenzo,90);
        mainGame.getGameState().pickTile(93, lorenzo);
        mainGame.getGameState().insertTile(3,4,lorenzo,180);

        gameController.endbuilding(loreto, 1);
        gameController.endbuilding(giuseppe, 2);
        gameController.endbuilding(giacomo, 3);
        gameController.endbuilding(lorenzo, 4);

        gameController.setNumTile(loreto,1);
        gameController.chooseOneSubShip(0,loreto);
        gameController.setNumTile(giuseppe,1);
        gameController.chooseOneSubShip(0,giuseppe);
        gameController.setNumTile(giacomo,1);
        gameController.chooseOneSubShip(0,giacomo);
        gameController.setNumTile(lorenzo,1);
    }

    @Test
    void buildingTestCannon1() throws Exception {
        EventBus b = mainGame.getEventBus();
        gameController = new GameController(mainGame, b);
        gameController.JoinGame("Loreto", 4);
        gameController.JoinGame("Giuseppe", 0);
        ...
        gameController.activateTimer(mainGame.getPlayer(loreto));
//PRIMO GIOCATORE
        mainGame.getGameState().pickTile(131, loreto);
        mainGame.getGameState().insertTile(2,4,loreto,90);
        mainGame.getGameState().pickTile(132, loreto);
        mainGame.getGameState().insertTile(3,4,loreto,180);
        mainGame.getGameState().pickTile(133, loreto);
        mainGame.getGameState().insertTile(2,5,loreto,270);


        mainGame.getGameState().pickTile(134, giuseppe);
        mainGame.getGameState().insertTile(2,4,giuseppe,90);
        mainGame.getGameState().pickTile(135, giuseppe);
        mainGame.getGameState().insertTile(3,4,giuseppe,180);

        mainGame.getGameState().pickTile(136, giacomo);
        mainGame.getGameState().insertTile(2,4,giacomo,90);
        mainGame.getGameState().pickTile(137, giacomo);
        mainGame.getGameState().insertTile(3,4,giacomo,180);

        mainGame.getGameState().pickTile(138, lorenzo);
        mainGame.getGameState().insertTile(2,4,lorenzo,90);
        mainGame.getGameState().pickTile(139, lorenzo);
        mainGame.getGameState().insertTile(3,4,lorenzo,180);
    ...
    @Test
    void buildingTestEngine2() throws Exception {
        EventBus b = mainGame.getEventBus();
        gameController = new GameController(mainGame, b);
        gameController.JoinGame("Loreto", 4);
        gameController.JoinGame("Giuseppe", 0);
...
//PRIMO GIOCATORE
        mainGame.getGameState().pickTile(85, loreto);
        mainGame.getGameState().insertTile(2,4,loreto,180);
        mainGame.getGameState().pickTile(86, loreto);
        mainGame.getGameState().insertTile(3,2,loreto,180);
        mainGame.getGameState().pickTile(87, loreto);
        mainGame.getGameState().insertTile(2,2,loreto,270);


        mainGame.getGameState().pickTile(88, giuseppe);
        mainGame.getGameState().insertTile(2,4,giuseppe,180);
        mainGame.getGameState().pickTile(89, giuseppe);
        mainGame.getGameState().insertTile(3,2,giuseppe,180);

        mainGame.getGameState().pickTile(90, giacomo);
        mainGame.getGameState().insertTile(2,4,giacomo,180);
        mainGame.getGameState().pickTile(91, giacomo);
        mainGame.getGameState().insertTile(3,2,giacomo,180);

        mainGame.getGameState().pickTile(92, lorenzo);
        mainGame.getGameState().insertTile(2,4,lorenzo,180);
        mainGame.getGameState().pickTile(93, lorenzo);
        mainGame.getGameState().insertTile(3,2,lorenzo,180);
    ...
    @Test
    void buildingTestCannon2() throws Exception {
        EventBus b = mainGame.getEventBus();
        gameController = new GameController(mainGame, b);
        gameController.JoinGame("Loreto", 4);
        gameController.JoinGame("Giuseppe", 0);
...
//PRIMO GIOCATORE
    ...
    @Test
    void buildingTestEngine3() throws Exception {
        EventBus b = mainGame.getEventBus();
        gameController = new GameController(mainGame, b);
        gameController.JoinGame("Loreto", 4);
        gameController.JoinGame("Giuseppe", 0);
...
//PRIMO GIOCATORE
        mainGame.getGameState().pickTile(85, loreto);
        mainGame.getGameState().insertTile(2,4,loreto,270);
        mainGame.getGameState().pickTile(86, loreto);
        mainGame.getGameState().insertTile(3,2,loreto,180);
        mainGame.getGameState().pickTile(87, loreto);
        mainGame.getGameState().insertTile(2,5,loreto,270);
        ...
        mainGame.getGameState().pickTile(88, giuseppe);
        mainGame.getGameState().insertTile(2,4,giuseppe,270);
        mainGame.getGameState().pickTile(89, giuseppe);
        mainGame.getGameState().insertTile(3,2,giuseppe,180);

        mainGame.getGameState().pickTile(90, giacomo);
        mainGame.getGameState().insertTile(2,4,giacomo,270);
        mainGame.getGameState().pickTile(91, giacomo);
        mainGame.getGameState().insertTile(3,2,giacomo,180);

        mainGame.getGameState().pickTile(92, lorenzo);
        mainGame.getGameState().insertTile(2,4,lorenzo,270);
        mainGame.getGameState().pickTile(93, lorenzo);
        mainGame.getGameState().insertTile(3,2,lorenzo,180);
    ...
    @Test
    void buildingTestCannon3() throws Exception {
        EventBus b = mainGame.getEventBus();
        gameController = new GameController(mainGame, b);
        gameController.JoinGame("Loreto", 4);
        gameController.JoinGame("Giuseppe", 0);
...
//PRIMO GIOCATORE
    ...
    @Test
    void buildingTestEngine4() throws Exception {
        EventBus b = mainGame.getEventBus();
        gameController = new GameController(mainGame, b);
        gameController.JoinGame("Loreto", 4);
        gameController.JoinGame("Giuseppe", 0);
...
//PRIMO GIOCATORE
    ...
    @Test
    void buildingTestCannon4() throws Exception {
        EventBus b = mainGame.getEventBus();
        gameController = new GameController(mainGame, b);
        gameController.JoinGame("Loreto", 4);
        gameController.JoinGame("Giuseppe", 0);
