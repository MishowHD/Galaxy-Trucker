...
class Card_EpidemicTest_build {
    ...
    void cardTest() throws Exception {
        ...
        gameController.pickTileUnknown(loreto);
        gameController.pickLittleDeck(1,loreto);
...
//PLAYER 3 SHIPBOARD
        ...
        mainGame.getPlayer(giacomo).getThingInHand();
        mainGame.getGameState().insertTile(4, 6, giacomo, 90);
        gameController.pickLittleDeck(0,giacomo);
        mainGame.getPlayer(giacomo).getThingInHand();
        assertTrue(mainGame.getPlayer(giacomo).isHasLittleDeckInHand());
        assertFalse(mainGame.getPlayer(giacomo).isHasTileInHand());
//PLayer 4
        gameController.pickLittleDeck(0,lorenzo);
        gameController.depositLittleDeck(giacomo);
        ...
        mainGame.getGameState().insertTile(10, 6, lorenzo, 0);
        mainGame.getGameState().insertTile(3, 6, lorenzo, 3);
        ...
        gameController.pickTileAlreadyFlipped(140, lorenzo);
        ...
        gameController.pickLittleDeck(0,lorenzo);
        gameController.depositTile(lorenzo);
        gameController.pickLittleDeck(1,lorenzo);
        gameController.pickLittleDeck(2,lorenzo);
        gameController.depositLittleDeck(lorenzo);
        gameController.depositLittleDeck(lorenzo);

        gameController.pickTileUnknown(lorenzo);
        gameController.addWaitTile(lorenzo);
        gameController.pickTileUnknown(lorenzo);
        gameController.addWaitTile(lorenzo);
        gameController.pickTileUnknown(lorenzo);
        gameController.addWaitTile(lorenzo);
        gameController.depositTile(lorenzo);
        gameController.insertWaitTile(lorenzo, 0,34,6,90);
        gameController.insertWaitTile(lorenzo, 0,4,6,91);
        gameController.insertWaitTile(lorenzo, 6,4,6,90);
        gameController.insertWaitTile(lorenzo, 0,4,6,90);
        mainGame.getGameState().insertTile(4, 6, lorenzo, 90);
        gameController.addWaitTile(lorenzo);
        gameController.insertWaitTile(lorenzo, 0,2,6,90);
        gameController.insertWaitTile(lorenzo, 0,2,6,90);
        gameController.insertWaitTile(lorenzo, 1,1,1,90);
        gameController.insertWaitTile(lorenzo, 1,1,1,90);
        gameController.pickTileUnknown(lorenzo);
        gameController.addWaitTile(lorenzo);
        gameController.pickTileUnknown(lorenzo);
