package it.polimi.ingsw.Cards.OpenSpace;

import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import it.polimi.ingsw.Model.Cards.OpenSpace.OpenSpaceFinal;
import it.polimi.ingsw.Model.Cards.OpenSpace.OpenSpacePreparation;
...
class Card_OpenSpaceTest {
    ...
    void setUp() {
        ...
        try (InputStream input = getClass().getResourceAsStream("/it.polimi.ingsw/open-space.json")) {
            if (input == null) {
...
//PLayer 4
        ...
        assertTrue(mainGame.getGameState().getCardinuse().getState() instanceof OpenSpacePreparation);
        mainGame.getGameState().getCardinuse().getState().getNextState();

        mainGame.getGameState().chooseToStartMotor(mainGame.getPlayer(giacomo), mainGame.getGameFlightBoard(), //6
                new ArrayList<>(List.of(
                        new ArrayList<>(List.of(3, 3)) //doppio motore
                )),
                new ArrayList<>(List.of(
        ...
        mainGame.getGameState().chooseToStartMotor(mainGame.getPlayer(loreto), mainGame.getGameFlightBoard(), //6
                new ArrayList<>(List.of(
        ...
        System.out.println("mi aspetto motion power di 6 sopra di me. player1");
...
//        tui.printCard(mainGame.getGameState().getCardinuse());
        ...
        mainGame.getGameState().chooseToStartMotor(mainGame.getPlayer(giuseppe), mainGame.getGameFlightBoard(), //6
                new ArrayList<>(List.of(
                        new ArrayList<>(List.of(4, 6)) //accendo questo doppio motore
                )),
                new ArrayList<>(List.of(
                        new ArrayList<>(List.of(1, 3, 1)) //uso queste batterie
                ))
        );
        System.out.println("mi aspetto motion power di 6 sopra di me. player 2");
        assertEquals(1, mainGame.getPlayer(giuseppe).getMyShip().getShipMatrix()[1][3].getNumCharges());

        mainGame.getGameState().chooseToStartMotor(mainGame.getPlayer(giacomo), mainGame.getGameFlightBoard(), //5
                new ArrayList<>(List.of(
                        new ArrayList<>(List.of(4, 4))
                )),
                new ArrayList<>(List.of(
                        new ArrayList<>(List.of(3, 5, 1))
                ))
        );
        System.out.println("mi aspetto motion power di 5 sopra di me. player 3");
        assertEquals(1, mainGame.getPlayer(giacomo).getMyShip().getShipMatrix()[3][5].getNumCharges());

        mainGame.getGameState().chooseToStartMotor(mainGame.getPlayer(lorenzo), mainGame.getGameFlightBoard(), //7
                new ArrayList<>(List.of(
                        new ArrayList<>(List.of(4, 1)),
                        new ArrayList<>(List.of(4, 4))
                )),
                new ArrayList<>(List.of(
        ...
        System.out.println("mi aspetto motion power di 7 sopra di me. player4");
        assertEquals(0, mainGame.getPlayer(lorenzo).getMyShip().getShipMatrix()[2][2].getNumCharges());

        assertTrue(mainGame.getGameState().getCardinuse().getState() instanceof OpenSpaceFinal);
        mainGame.getGameState().getCardinuse().getState().getNextState();
        assertEquals(12, mainGame.getPlayer(giuseppe).getPositionOnBoard());
        assertEquals(0, mainGame.getPlayer(giuseppe).getNumFullRounds());
        assertEquals(9, mainGame.getPlayer(loreto).getPositionOnBoard());
        assertEquals(0, mainGame.getPlayer(loreto).getNumFullRounds());
        assertEquals(6, mainGame.getPlayer(giacomo).getPositionOnBoard());
        assertEquals(0, mainGame.getPlayer(giacomo).getNumFullRounds());
        assertEquals(8, mainGame.getPlayer(lorenzo).getPositionOnBoard());
        assertEquals(0, mainGame.getPlayer(lorenzo).getNumFullRounds());
